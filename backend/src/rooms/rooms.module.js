...
let RoomsModule = exports.RoomsModule = (() => {
    ...
    let _classThis;
    var RoomsModule = _classThis = class {
    };
    __setFunctionName(_classThis, "RoomsModule");
    (() => {
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name }, null, _classExtraInitializers);
        RoomsModule = _classThis = _classDescriptor.value;
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RoomsModule = _classThis;
})();
